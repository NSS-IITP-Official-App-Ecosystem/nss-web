...
const stats = [
    { value: "64", label: "Dedicated Volunteers" },
    { value: "4+", label: "Villages Reached" },
...
const initiatives = [
    {
        ...
        subtitle: "Grassroots Shramdaan & Audits",
        description: "NSS volunteers regularly organize intensive cleanliness drives in nearby adopted villages and public campus areas, clearing garbage and introducing safe disposal systems.",
        highlights: [
            "Regular shramdaan cleanups across IIT Patna.",
            "Focus on waste management audits in rural zones.",
            "Safai Mitra recognition and sanitation safety.",
            "Direct interaction with village heads on public hygiene."
        ]
    },
    {
        id: "swachhata",
        title: "Nationwide Swachhata Campaigns",
        subtitle: "Swachhata Hi Seva Campaigns",
        description: "Leading the local chapter of the Swachhata Hi Seva campaign (17 September to 2 October). Volunteers conduct massive community outreach, street cleanups, and local sensitization drives.",
        highlights: [
            "15-day focused national sanitation timeline.",
            "Safai Mitra Suraksha Shivir health camps support.",
            "Door-to-door hygiene awareness in village blocks.",
            "Mass cleanliness pledge coordinates."
        ]
    },
    {
        id: "theater",
        title: "Advocacy & Street Theatre",
        subtitle: "Nukkad Natak Street Plays",
        description: "Conceiving, rehearsing, and performing street plays (like the acclaimed 'Pattiyon Ke Paar') to raise awareness on social challenges like women empowerment, domestic safety, and literacy.",
        highlights: [
            "NSS Nukkad Team on-ground theater coordinates.",
            "High-impact scripts on social safety & legal rights.",
            "Engagements in local village centers and schools.",
            "Interactive discussions following performances."
        ]
    }
];
        ...
        <div className="min-h-screen bg-[#FAF9F6] text-slate-800 font-sans pb-32 relative">
            ...
            <header className="bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white pt-24 pb-48 px-4 text-center relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto relative z-10 flex flex-col items-center">
                    ...
                    <div className="h-20 w-20 md:h-24 md:w-24 rounded-full overflow-hidden border-2 border-amber-400 shadow-xl mb-6 bg-white shrink-0">
                        <img src="/wings/rural.png" alt="Rural Development Wing Logo" className="h-full w-full object-cover" />
                    </div>
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-6 shadow-sm">
                        <span className="text-slate-300 text-[10px] font-black uppercase tracking-widest leading-none">
                            Empowering Villages, Building India
                        </span>
                    </div>
            ...
            <section className="max-w-6xl mx-auto px-4 mt-24">
                <div className="text-center mb-12">
                    <span className="text-[10px] font-black text-amber-600 uppercase tracking-widest bg-amber-50 border border-amber-200 px-3 py-1 rounded-full">Core Rural Focus</span>
