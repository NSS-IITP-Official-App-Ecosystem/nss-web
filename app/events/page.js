...
export default function EventsPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-800">
      ...
      {/* 4. Footer */}
      <footer className="bg-slate-950 text-slate-400 border-t border-slate-900 pt-16 pb-12 text-xs font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-slate-900">
            ...
            <div>
              ...
              <ul className="space-y-3 font-bold uppercase tracking-wider text-slate-400">
                ...
                <li><a href="#" className="hover:text-amber-500 transition-colors">Volunteering Guidelines</a></li>
              </ul>
            </div>
            {/* Contact details */}
            <div>
