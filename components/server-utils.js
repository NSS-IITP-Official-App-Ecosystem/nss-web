...
export const resolveEventThumbnail = async (eventMedia) => {
    if (!eventMedia || eventMedia.length === 0) return "/units/chetna_final.jpg";
    ...
    const img = resolved.find(m => m.type === 'image');
    return img ? img.url : "/units/chetna_final.jpg";
};
